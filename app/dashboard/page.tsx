            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-green-100">Estimated Refund</p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Refund calculated</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">April 15, 2024</p>
                    </div>
                    <span className="text-xs bg-red-100 text-red-800 px-2 py-1 rounded-full">15 days left</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    ...
                    <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full">77 days left</span>
                  </div>
                </div>
              </div>
            </div>
