    ...
    enhancements: [
      {
        ...
        description: "Test different scenarios to see how changes affect your tax liability and refund amount.",
        icon: "ri-line-chart-line",
        color: "bg-purple-100 text-purple-600"
      },
      {
        title: "Completeness Meter",
        description: "Real-time progress indicator showing how complete your tax return is and what's missing.",
        icon: "ri-progress-3-line",
        color: "bg-green-100 text-green-600"
      },
      {
        title: "Benefits Screener",
        description: "Automatically identifies all tax credits and deductions you're eligible for.",
        icon: "ri-search-eye-line",
        color: "bg-blue-100 text-blue-600"
      },
      {
        title: "MFA Vault",
        description: "Secure multi-factor authentication vault to protect your sensitive tax documents.",
