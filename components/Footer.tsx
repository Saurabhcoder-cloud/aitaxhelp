            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  ...
                  <a href="mailto:help@tradenetsolution.com" className="text-gray-300 hover:text-white transition-colors cursor-pointer">
                    help@tradenetsolution.com
                  </a>
                </li>
                <li className="flex items-center">
                  <i className="ri-phone-line text-blue-400 mr-3"></i>
                  <a href="tel:+91-8948894006" className="text-gray-300 hover:text-white transition-colors cursor-pointer">
                    +91-8948894006
                  </a>
                </li>
              </ul>
