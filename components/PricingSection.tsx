    ...
    plans: [
      {
        ...
        description: "This is a one-time registration fee that gives clients lifetime access to the website and its features. After paying this small fee once, clients can use the website every year to file their tax returns without any renewal or subscription charges.",
      ...
      },
      {
        ...
        price: 19.99,
        priceLabel: "Per Filing",
        description: "Fee for preparing a tax return for a single individual (one client filing only for themselves). The client pays only once a year, when filing their return. No monthly or annual subscription applies.",
        icon: "ri-user-line",
        popular: true
      },
      {
        ...
        price: 24.99,
        priceLabel: "Per Filing",
        description: "Fee for preparing a tax return for a married couple (husband and wife filing jointly). This is referred to as a 'family return'. This is a one-time annual filing fee that includes both individuals in a single return.",
        icon: "ri-team-line",
        popular: false
      }
    ]
    ...
    <section className="py-20 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-8 bg-white rounded-full px-8 py-4 shadow-lg border border-gray-200">
            <div className="flex items-center text-gray-700">
              <i className="ri-shield-check-line text-green-500 mr-2"></i>
              <span className="font-medium">30-day money-back guarantee</span>
            </div>
            <div className="flex items-center text-gray-700">
              <i className="ri-customer-service-2-line text-blue-500 mr-2"></i>
