  ...
  en: {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Comprehensive tax calculation engine that identifies all eligible deductions and credits to maximize your refund.",
      ...
      },
      {
        ...
        description: "Support for tax filing in multiple countries with localized tax rules and regulations for accurate compliance.",
        icon: "ri-global-line"
      }
    ]
  },
